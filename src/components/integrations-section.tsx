      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {integrations.map((integration, index) => (
            <div key={index} className="bg-slate-700 rounded-2xl p-8 border border-slate-600 hover:border-violet-500 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
