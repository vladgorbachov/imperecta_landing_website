        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className="bg-slate-800/70 backdrop-blur-sm rounded-2xl p-8 border border-slate-700 hover:border-violet-500 transition-all duration-300 hover:shadow-xl">
                ...
                <div className="text-slate-200 text-sm">{stat.description}</div>
              </div>
            </div>
          ))}
        </div>
